...
export class ZetaHelperMain {
     ...
     * @param threadJs - URL for JS code file running inside the document thread (web worker).
            ...
            switch (e.data.cmd) {
                case 'ZetaHelper::run_thr_script':
                    ...
                    if (threadJs) {
                        ...
                        console.log('zetaHelper: Document runtime loaded. No threadJs given.');
                    }
                    break;
                default:
                    throw Error('Unknown message command: ' + e.data.cmd);
...
/**
 * Helper for inside the document thread (web worker).
 * @beta
 */
